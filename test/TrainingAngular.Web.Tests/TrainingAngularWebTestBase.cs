...
{
    public abstract class TrainingAngularWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TrainingAngularWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TrainingAngularWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TrainingAngularDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TrainingAngularDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TrainingAngularDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TrainingAngularDbContext, Task<T>> func)
        {
            T result;
